        ...
        <div className="flex flex-1 justify-start flex-col mf:mr-20">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center p-3 my-5 bg-[#2952e3] rounded-full cursor-pointer hover:bg-[#2546bd]"
            >
          ...
          <div className="grid sm:grid-cols-3 grid-cols-4 mt-10">
